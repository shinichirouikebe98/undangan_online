...
<div class=" max-md:w-4/5 h-[80vh] w-2/4 m-auto rounded-2xl flex flex-col items-center justify-center gap-8 shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
    <p class="text-3xl text-gray-500 font-bold">Register</p>
    <form class="max-md:w-4/5 w-full max-w-sm" method="POST" action="{{ route('register') }}">
      @csrf
      <div class="md:flex md:items-center mb-6">
        ...
        <div class="md:w-2/3">
          <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="name" type="text" @error('name') is-invalid @enderror name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
          @error('name')
      ...
      <div class="md:flex md:items-center">
        ...
        <div class="w-full flex">
          <button class="w-full shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2  rounded" type="submit">
            {{ __('Register') }}
          </button>
        </div>
      </div>
